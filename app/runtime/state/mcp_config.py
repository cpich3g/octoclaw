...
_BUILTIN_SERVERS: dict[str, dict[str, Any]] = {
    ...
    "coingecko": {
        "type": "http",
        "url": "https://coingecko-mcp.politedune-c19de043.swedencentral.azurecontainerapps.io/mcp",
        "headers": {"Authorization": "Bearer ${MCP_API_KEY}"},
        "tools": ["*"],
        "enabled": True,
        "builtin": True,
    ...
    "alpaca": {
        "type": "http",
        "url": "https://alpaca-mcp.politedune-c19de043.swedencentral.azurecontainerapps.io/mcp",
        "headers": {"Authorization": "Bearer ${MCP_API_KEY}"},
        "tools": ["*"],
        "enabled": True,
        "builtin": True,
        "description": "Alpaca trading and market data MCP server",
    },
    "f1": {
        "type": "http",
        "url": "https://f1-mcp.politedune-c19de043.swedencentral.azurecontainerapps.io/mcp/v1",
        "headers": {"Authorization": "Bearer ${MCP_API_KEY}"},
        "tools": ["*"],
        "enabled": True,
        "builtin": True,
        "description": "Formula 1 data and statistics MCP server",
    },
}
